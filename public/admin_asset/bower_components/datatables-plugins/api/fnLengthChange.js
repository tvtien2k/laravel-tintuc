/**
 * Change the number of records that can be viewed on a single pages in
 * DataTables.
 *
 * DataTables 1.10 provides the `dt-api pages.len()` method to get and set the
 * pages length using the built-in API. As such this method is marked deprecated,
