/**
 * Apply the same filter to all DataTable instances on a particular pages. The
 ...
 * filter to all tables on the pages. The new API should be used in preference
 * to this older method if at all possible.
 *
 *  @name fnFilterAll
 *  @summary Apply a common filter to all DataTables on a pages
