 ...
 * using to display each pages, including the number of records shown, start
 * and end points in the data set etc.
 *
 * DataTables 1.10+ provides the `dt-api pages.info()` method, built-in, provide
 ...
 *            alert( 'Now on pages'+ this.fnPagingInfo().iPage );
 *          }
 *        } );
 *    } );
 */
