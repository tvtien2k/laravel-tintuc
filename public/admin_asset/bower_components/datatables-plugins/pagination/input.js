 ...
 * enter which pages they wish to jump to manually. This paging control uses a
 ...
 *  @summary Shows an input element into which the user can type a pages number
...
$.fn.dataTableExt.oPagination.input = {
	"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
	{
		...
		// If we can't pages anyway, might as well not show it
	...
	"fnUpdate": function ( oSettings, fnCallbackDraw )
	{
		...
		if (iPages <= 1) // hide paging when we can't pages
		{
			$(an).hide();
		}
		else
